...
{
    private static final String FocusEvent = null;
    JButton SUBMIT;
    ...
    MarvellousLogin()
    {
        ...
        text2.addFocusListener(new FocusListner()
        {
           public void focusGained(FocusEvent e)
           {

           }
           public void focusLost(FocusEvent equals)
           {
               label3.setText("");
           }
        });
        ...
        Dimension l3size=label3.getMinimumSize();
